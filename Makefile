...
lint-py:  ## run python linter with ruff
	python -m ruff check nepenthe
	python -m ruff format --check nepenthe
...
fix-py:  ## fix python formatting with ruff
	python -m ruff check --fix nepenthe
	python -m ruff format nepenthe
...
test-py:  ## run python tests
	python -m pytest -v nepenthe/tests

# alias
tests-py: test-py

coverage-py:  ## run python tests and collect test coverage
	python -m pytest -v nepenthe/tests --cov=nepenthe --cov-report term-missing --cov-report xml
