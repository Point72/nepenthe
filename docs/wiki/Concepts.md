...
2. every selected **feature**'s dependencies (including those inherited via
   `extends`),
3. the selected **variant**'s dependencies, constraints, and virtual packages,
4. the chosen **python** (injected as `python <ver>.*`).
